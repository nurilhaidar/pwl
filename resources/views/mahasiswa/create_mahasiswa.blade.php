                    ...
                    <form action="{{ $url_form }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama"
                                value="{{ isset($mhs) ? $mhs->nama : old('nama') }}">
                            @error('nama')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label>Kelas</label>
                            <select class="form-control  @error('kelas') is-invalid @enderror" name="id_kelas">
                                <option value=""></option>
                                @foreach ($kelas as $k)
                                    <option value="{{ $k->id }}"
                                        {{ isset($mhs) ? ($mhs->id_kelas == $k->id ? 'selected' : '') : '' }}>
                                        {{ $k->nama_kelas }}</option>
                                @endforeach
                            </select>
                            @error('kelas')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('img') is-invalid @enderror" type="file" name="img"
                                value="{{ isset($mhs) ? $mhs->img : old('img') }}">
                            @error('img')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                            @isset($mhs)
                                <img src="/storage/{{ $mhs->img }}" width="50px">
                            @endif
                        </div>
                            <div class="form-group">
                                <label>Jenis Kelamin</label>
                                <input class="form-control @error('jk') is-invalid @enderror" type="text" name="jk"
                                    value="{{ isset($mhs) ? $mhs->jk : old('jk') }}">
                                @error('jk')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control @error('tempat_lahir') is-invalid @enderror" type="text"
                                    name="tempat_lahir" value="{{ isset($mhs) ? $mhs->tempat_lahir : old('tempat_lahir') }}">
                                @error('tempat_lahir')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('alamat') is-invalid @enderror" type="text" name="alamat"
                                    value="{{ isset($mhs) ? $mhs->alamat : old('alamat') }}">
                                @error('alamat')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label>No HP</label>
                                <input class="form-control @error('hp') is-invalid @enderror" type="text" name="hp"
                                    value="{{ isset($mhs) ? $mhs->hp : old('hp') }}">
                                @error('hp')
                                    <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
